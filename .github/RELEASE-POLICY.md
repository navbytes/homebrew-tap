...
Formula and cask updates arrive as PRs from producer repositories. Review and merge the generated PR; no binary publisher is needed in this tap.
...
Routine dependency updates share one weekly multi-ecosystem group where configured. Security updates

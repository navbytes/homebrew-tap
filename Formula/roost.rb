# roost — copied from navbytes/roost's packaging/homebrew/roost.rb (the source
# of truth). Per release: update THAT file (version + every sha256 from the
# release's SHA256SUMS.txt), then copy it here. The values below are v0.1.5's.
class Roost < Formula
